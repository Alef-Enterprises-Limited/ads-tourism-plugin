...
final class RecordFieldSchema
{
    ...
    private function common(): array
    {
        return [
            ...
            $this->field('gallery_max_images', 'Gallery maximum images', FieldType::INTEGER, default: 0),
            $this->field('gallery_columns', 'Gallery columns', FieldType::INTEGER, default: 3),
            $this->field(
                'gallery_order',
                'Gallery order',
                FieldType::SELECT,
            ...
            $this->field('gallery_image_size', 'Gallery WordPress image size', default: 'large'),
            $this->field('gallery_show_captions', 'Show gallery captions', FieldType::BOOLEAN, default: true),
            $this->field('gallery_show_credits', 'Show gallery credits', FieldType::BOOLEAN, default: false),
            $this->field('gallery_lightbox', 'Enable gallery lightbox', FieldType::BOOLEAN, default: true),
            $this->field('gallery_include_featured', 'Include featured image in gallery', FieldType::BOOLEAN, default: false),
            $this->field(
                'gallery_pagination',
                'Gallery pagination',
                FieldType::SELECT,
